...
import json
import traceback
import sys # Already in your original script
import os
...
### MODIFICATION 1: Fix for the "maximum recursion" error
...
### MODIFICATION 2: Changed to a safer interval to prevent sleeping
SELF_PING_INTERVAL_SECONDS = 14 * 60  # 14 minutes
PING_REQUEST_TIMEOUT = 20

# --- Core GDFLIX Bypass Function ( YOUR ORIGINAL LOGIC - UNCHANGED ) ---
def get_gdflix_download_link(start_url):
    # ... YOUR ENTIRE ORIGINAL get_gdflix_download_link FUNCTION ...
    # ... THIS LOGIC HAS NOT BEEN MODIFIED AT ALL ...
                        ...
                        if drivebot_server_next_url:
                            ...
                            if generate_link_button:
                                ...
                                if http_method_generate == 'POST':
                                    ...
                                    response_generate = session.get(post_url_generate, params=post_data_generate, headers=generate_headers, timeout=REQUEST_TIMEOUT, allow_redirects=T)
...
# --- Self-Ping Endpoint ( UNCHANGED ) ---
@app.route('/ping', methods=['GET'])
def ping_service():
    app.logger.info("Ping endpoint called successfully.")
    return "pong", 200

# --- Self-Ping Background Task ( UNCHANGED ) ---
def self_ping_task():
...
# --- Run Flask App ---
### MODIFICATION 3: This part is changed to work with Gunicorn on Render
...
if __name__ == '__main__':
    ...
    # This app.run is for local testing only. Gunicorn runs the app on Render.
